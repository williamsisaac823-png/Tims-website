...
(() => {
  ...
  const stylesheet =
    ...
    /* Replace/Edit hover controls disabled site-wide per request */
  ...
  class ImageSlot extends HTMLElement {
    ...
    _render() {
      ...
      const url = this._userUrl || ((typeof window !== 'undefined' && window.__resources && window.__resources[srcAttr]) || srcAttr);
      ...
      // SEO: give the rendered <img> real alt text — an explicit alt wins,
      // otherwise fall back to the human-readable placeholder caption.
